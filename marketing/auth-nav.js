...
(function () {
  ...
  function ensureStyles() {
    ...
    style.textContent = `
      ...
      .aft-auth-btn:hover { border-color: var(--beacon, #e85d1a); }
      ...
      .aft-auth-avatar {
        ...
        background: var(--beacon, #e85d1a); color: var(--beacon-ink, #140c08); display: inline-flex;
      ...
      .aft-auth-menu {
        ...
        min-width: 12rem; background: var(--panel, #101218); border: 1px solid var(--line, #1e232c);
        border-radius: 4px; box-shadow: 0 12px 32px rgba(0,0,0,0.45);
        padding: 0.35rem; z-index: 50; color: var(--ink, #f2f4f7);
      ...
      .topnav .aft-auth-avatar { background: var(--beacon, #e85d1a); color: #140c08; }
      .topnav .aft-auth-menu { background: #12151b; border-color: var(--line, rgba(255,255,255,0.14)); color: #e8eaef; }
      ...
      [data-aft-auth="guest"][hidden] { display: none !important; }
  ...
  function hideSignedInCtas() {
    for (const nav of document.querySelectorAll(".topnav, .docs-top, .seo-top, .bar")) {
